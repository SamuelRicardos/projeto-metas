...
if (isset($_POST['id'])) {
    ...
    if(!$id) {
        $stm = $con->prepare("INSERT INTO metas (descricao,situacao) VALUES(:descricao,
        :situacao)");
    } else {
    ...
    <form method="post" autocomplete="off">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="descricao" value="<?= $descricao ?>" name="descricao" required />
